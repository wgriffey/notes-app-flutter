import 'package:practiceapp/services/auth/auth_exceptions.dart';
import 'package:practiceapp/services/auth/auth_provider.dart';
import 'package:practiceapp/services/auth/auth_user.dart';
...
void main() {
  group('Mock Authentication', () {
    ...
    test(
        "Should not log out when not initialized",
        () => {
              expect(
                provider.logOut(),
