...
import 'package:practiceapp/utilities/dialogs/password_reset_email_sent_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            ...
            await showErrorDialog(context,
                'We could not process your request. Ensure that you are a registered user.');
          }
        }
      },
      child: Scaffold(
